    ...
    <section className="w-full py-20 grid place-content-center font-gilLight font-bold ">
      <div className="max-w-5xl  px-8 border-solid border-2 border-black rounded-md rounded-br-3xl p-4">
        <div className="w-full flex flex-col gap-12 sml:gap-8 text-2xl ">
          <h2 className="text-3xl">Walking in the Garden</h2>
      ...
      <div className="w-full flex flex-col items-center justify-center gap-8">
            ...
            <a
              ...
              className="bg-amber-600 text-white text-2xl rounded-full p-1 px-4 font-gilLight capitalize hover:scale-105 transition-transform hover:text-amber-500 self-center -translate-x-[0.25rem]"
              target="_blank"
              >
