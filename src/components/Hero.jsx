...
const Hero = ({ id }) => {
  ...
  return (
    <>
      ...
      w-full p-4 px-20 uppercase font-gil  flex xxs:flex-col sm:text-[12px] sm:px-2 sm:flex-wrap md:px-4 md:items-center md:gap-0 justify-between  md:text-sm text-xl font-bold sticky top-0 z-30`}
      >
        <SmoothScroll
          id="home"
          title={<FaHome className="md:text-2xl text-3xl" />}
          offset={-105}
        />
